<template>
  <div class="comment-item">
    <div class="header mb-5">
      ...
      <div class="like-btn">
        <auth-action>
          <n-icon @click="onHandleToggleLike" color="red" size="20">
            <component :is="isLiked?Heart:HeartOutline"></component>
          </n-icon>
        </auth-action>
        <count-format class="ml-5" :count="comment.like_count" size="14px"></count-format>
      </div>
    </div>
...
// props
const props = defineProps<{ comment: CommentType; isLiked: boolean; likeCount: number }>()
// emits
